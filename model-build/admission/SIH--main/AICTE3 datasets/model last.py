...
def classify(city,course,dataframe):
    main_df=dataframe.loc[dataframe['CITY'].str.contains(city) & dataframe['COURSE'].str.contains(course)]
    return main_df
...
data = pd.read_excel("C:\\Users\\Viswes\\testingtest.xlsx")
...
def testpreprocessing(city,course,data):
    ...
    print("Enrollment percentage of the college is",yrand_pred/df1['INTAKE']) 
    print("PLACEMENT percentage of the college is ",yrand_pred1/df1['INTAKE']) 

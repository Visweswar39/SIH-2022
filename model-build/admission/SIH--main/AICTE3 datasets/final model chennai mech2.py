def classify(city,course,dataframe):
    main_df=dataframe.loc[dataframe['CITY'].str.contains('Chennai') & dataframe['COURSE'].str.contains('MECHANICAL ENGINEERING')]
    return main_df
...
X_train1,y_train1,X,y=preprocessing('Chennai','CIVIL ENGINEERING')
rand_clf1,rand_clf2=training(X_train1,y_train1,X,y)
X_test1,y_test1,X1,y1,emp_potential_real=testpreprocessing('Visakhapatnam','CIVIL ENGINEERING')
